...
![Página del reto](recurso/Desafio.PNG)
...
![Página del reto](recurso/Pagina.PNG)
...
![Archivo words.wasm](recurso/words.PNG)
...
![Salida del script de Python](recurso/respuesta.png)



### Validación y flag
- Combinando las palabras obtenidas, la flag final es: K17{limbo, urban, fiber}
![Flag encontrada subida](recurso/Resuelto.PNG)
